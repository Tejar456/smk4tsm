...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="grid sm:grid-cols-2 lg:grid-cols-4 items-center gap-2">
    ...
    <a class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-none focus:bg-gray-50 rounded-xl p-4 md:p-7" href="#">
      <div class="flex justify-center items-center size-12 bg-blue-600 rounded-xl">
        <svg viewBox="-12.7 -12.7 76.20 76.20" xmlns="http://www.w3.org/2000/svg" xml:space="preserve" fill="#ffffff" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g style="stroke-width:1.00012;stroke-dasharray:none"> <path d="M12.965 29.31h10.92l-1.55 15.013c-.052.784.348.955.941 0l14.55-22.834" style="fill:none;stroke:#ffffff;stroke-width:3.175;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"></path> <path d="M37.826 21.49h-10.92l1.549-15.013c.052-.784-.348-.955-.941 0l-14.55 22.834" style="fill:none;stroke:#ffffff;stroke-width:3.175;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none"></path> </g> </g></svg>
      </div>
      <div class="mt-5">
        <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">24/7 Support</h3>
        <p class="mt-1 text-gray-600">Contact us 24 hours a day, 7 days a week</p>
