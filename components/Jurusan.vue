<template>
  ...
  <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
      <h2 class="text-2xl font-bold md:text-4xl md:leading-tight">Kompetensi Keahlian</h2>
      <p class="mt-1 text-gray-600">Kompetensi kehlaian yang ada di SMKN 4 Tasikmalaya</p>
    </div>
    <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-2">
      ...
      <a data-aos="fade-up" data-aos-delay="0" class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-none focus:bg-gray-50 rounded-xl p-4 md:p-7"
        ...
        <div  class="flex items-center gap-5">
          ...
          <div>
            <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">PPLG</h3>
          </div>
        </div>
        <div class="mt-5">
      ...
      <a data-aos="fade-up" data-aos-delay="200" class="group flex flex-col justify-center hover:bg-gray-50 focus:outline-none focus:bg-gray-50 rounded-xl p-4 md:p-7"
        ...
        <div  class="flex items-center gap-5">
          ...
          <div>
            ...
            <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">TJKT</h3>
          </div>
        </div>
        <div class="mt-5">
        ...
        <div class="flex items-center gap-5">
          <div class="flex justify-center items-center size-12 bg-blue-600 rounded-xl">
            <svg xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:cc="http://creativecommons.org/ns#"
              ...
              xmlns:inkscape="http://www.inkscape.org/namespaces/inkscape" viewBox="-3 -3 36.00 36.00" version="1.1"
              id="svg822" inkscape:version="0.92.4 (f8dce91, 2019-08-02)" sodipodi:docname="design.svg" fill="#ffffff"
              stroke="#ffffff">
              <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
              <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
              <g id="SVGRepo_iconCarrier">
                <defs id="defs816"> <inkscape:path-effect only_selected="false" apply_with_weight="true"
                    apply_no_weight="true" helper_size="0" steps="2" weight="33.333333" is_visible="true"
                    id="path-effect1025" effect="bspline"></inkscape:path-effect> <inkscape:path-effect
                    only_selected="false" apply_with_weight="true" apply_no_weight="true" helper_size="0" steps="2"
                    weight="33.333333" is_visible="true" id="path-effect1021" effect="bspline"></inkscape:path-effect>
                </defs>
                <sodipodi:namedview id="base" pagecolor="#ffffff" bordercolor="#666666" borderopacity="1.0"
                  inkscape:pageopacity="0.0" inkscape:pageshadow="2" inkscape:zoom="17.833333" inkscape:cx="19.485981"
                  inkscape:cy="13.037383" inkscape:document-units="px" inkscape:current-layer="layer1" showgrid="true"
                  units="px" inkscape:window-width="1366" inkscape:window-height="713" inkscape:window-x="0"
                  inkscape:window-y="0" inkscape:window-maximized="1" showguides="false" inkscape:guide-bbox="true">
                  <sodipodi:guide position="21.126168,22.794393" orientation="1,0" id="guide1575"
                    inkscape:locked="false"></sodipodi:guide>
                  <sodipodi:guide position="22.682243,23.285047" orientation="1,0" id="guide1635"
                    inkscape:locked="false"></sodipodi:guide>
                  <sodipodi:guide position="22.682243,7.6455921" orientation="0,1" id="guide1639"
                    inkscape:locked="false"></sodipodi:guide>
                  <sodipodi:guide position="18.859863,18.859863" orientation="1,0" id="guide1242"
                    inkscape:locked="false"></sodipodi:guide>
          ...
          <div>
            ...
            <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">DKV</h3>
          </div>
        </div>
        <div class="mt-5">
      ...
      <a data-aos="fade-up" data-aos-delay="200"
        ...
        <div class="flex items-center gap-5">
            ...
            <svg viewBox="-12.7 -12.7 76.20 76.20" xmlns="http://www.w3.org/2000/svg" xml:space="preserve"
              ...
              <g id="SVGRepo_iconCarrier">
                <g style="stroke-width:1.00012;stroke-dasharray:none">
                  <path d="M12.965 29.31h10.92l-1.55 15.013c-.052.784.348.955.941 0l14.55-22.834"
                    style="fill:none;stroke:#ffffff;stroke-width:3.175;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none">
                  </path>
                  <path d="M37.826 21.49h-10.92l1.549-15.013c.052-.784-.348-.955-.941 0l-14.55 22.834"
                    style="fill:none;stroke:#ffffff;stroke-width:3.175;stroke-linecap:round;stroke-linejoin:round;stroke-dasharray:none">
                  </path>
                </g>
              </g>
          ...
          <div>
            <h3 class="group-hover:text-gray-600 text-lg font-semibold text-gray-800">TOI</h3>
          </div>
        </div>
        <div class="mt-5">
          <p class="mt-1 text-gray-600">Contact us 24 hours a day, 7 days a week</p>
